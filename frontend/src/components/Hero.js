        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center justify-center space-x-8 pt-8">
            ...
            <a
              ...
              className="p-3 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors duration-200 group"
            >
              <Phone className="w-6 h-6 text-gray-700 group-hover:text-gray-900" />
            </a>
            <a
              href={data.linkedin}
              target="_blank"
          ...
          <div className="pt-16">
            <button
              ...
              className="animate-bounce p-2 rounded-full hover:bg-gray-100 transition-colors duration-200"
            >
